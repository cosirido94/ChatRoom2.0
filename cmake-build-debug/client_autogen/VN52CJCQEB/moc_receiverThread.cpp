...
QT_MOC_LITERAL(1, 15, 19), // "nickNameNotAvaiable"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 15), // "messageReceived"
QT_MOC_LITERAL(4, 52, 6), // "header"
QT_MOC_LITERAL(5, 59, 7) // "message"

    },
    "ReceiverThread\0nickNameNotAvaiable\0\0"
    "messageReceived\0header\0message"
};
...
void ReceiverThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->nickNameNotAvaiable(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReceiverThread::nickNameNotAvaiable)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ReceiverThread::*)(const QString , const QString );
...
// SIGNAL 0
void ReceiverThread::nickNameNotAvaiable()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ReceiverThread::messageReceived(const QString _t1, const QString _t2)
{
